...
function ProductList() {
  ...
  useEffect(() => {
    ...
    //  the loading response Apollo provides to indicate that we're still waiting for a response won't exist, because we're no longer waiting for data. The data simply isn't coming.
    else if (!loading) {
